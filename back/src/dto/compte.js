...
/************************************************ */
    async recupererCompteParId(id) {
        ...
        // Normaliser le format de retour pour l'app mobile
        if (compte) {
            return {
                id: compte.idCompte,
                nom: compte.nomCompte,
                email: compte.adresseMailCompte,
                stockageCompte: compte.stockageCompte,
                // Format BDD pour compatibilité
                idCompte: compte.idCompte,
                nomCompte: compte.nomCompte,
                adresseMailCompte: compte.adresseMailCompte,
            };
        }
        return null;
    }

            ...
            <View style={[styles.filtersContainer, { backgroundColor: theme.isDark ? '#1C1C1E' : '#F9F9F9' }]}> 
              ...
              {(searchQuery !== '' || filterType !== 'tous' || filterDate !== 'tous') && (
                <>
                  ...
                  >
                    <Text style={[styles.resetFiltersText, { color: theme.primaryColor }]}>Réinitialiser les filtres</Text>
                  </TouchableOpacity>
                </>
              )}
            </View>
          ...
          <View style={styles.actionBar}>
            {!isInTrash ? (
              ...
              <View style={[styles.trashInfoContainer, { backgroundColor: theme.isDark ? '#2C2C2E' : '#F2F2F7' }]}> 
                <Text style={[styles.trashInfoText, { color: theme.textColor }]}>Taille totale : {formatFileSize(trashSize)}</Text>
              </View>
            )}
          </View>
        </>
